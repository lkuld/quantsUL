...
*In the last tutorial, we encountered numeric and character vectors: ordered (order is important) collection of objects. In this tutorial we will look at grouped vectors, for instance a table.*
